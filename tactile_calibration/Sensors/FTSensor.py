...
class FTSensor(Sensor):
    ...
    def __init__(self):
        ...
        """
        self.name = "FTSensor"
        self.x_offset = 55 #x coordinate of corner of testbed
        self.y_offset = 64.5 #y coordinate of corner of testbed
        self.z_offset = 103 #z coordinate of corner of testbed + 1.5 mm, 66 for with bendable plate, 98.1 for without bendable plate, 101.1 with membrane
        self.z_clearance = 6 #how high it moves when moving
        self.max_penetration = 5 #limit on how deep the z will move
