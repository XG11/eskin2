...
class FTSensor(Sensor):
    ...
    def __init__(self):
        ...
        self.y_offset = 68 #y coordinate of corner of testbed
        self.z_offset = 107.1 #z coordinate of corner of testbed + 1.5 mm, 66 for with bendable plate, 98.1 for without bendable plate, 101.1 with membrane
